...
DROP TABLE IF EXISTS william_assignment_temp;

CREATE TEMP TABLE william_assignment_temp AS
(
    SELECT 
...
DROP TABLE IF EXISTS william_availability_temp;

CREATE TEMP TABLE william_availability_temp AS
...
-- ************************************************
/* CREATING THE AVAILABILITY/ASSIGNMENT TEMP TABLE */
-- ************************************************

DROP TABLE IF EXISTS william_availability_assignment;

CREATE TEMP TABLE william_availability_assignment AS
...
(
    ...
    FROM
    william_availability_temp a
    INNER JOIN william_assignment_temp b 
      ON 
        (
            b.date = a.date AND
...
-- *********************************
/* CREATING THE BOOKED ORDERS TABLE */
-- *********************************

DROP TABLE IF EXISTS william_booked_orders_temp;

CREATE TEMP TABLE william_booked_orders_temp AS
...
-- *************************************
/* CREATING THE FORECASTED ORDERS TABLE */
-- *************************************

DROP TABLE IF EXISTS william_forecasted_orders_temp;

CREATE TEMP TABLE william_forecasted_orders_temp AS
...
-- *************************************************
/* CREATING THE JOINED BOOKED/FORECASTED TEMP TABLE */
-- *************************************************

DROP TABLE IF EXISTS william_booked_forecasted_temp;

CREATE TEMP TABLE william_booked_forecasted_temp AS
...
(
    ...
    FROM
    william_booked_orders_temp a
    FULL OUTER JOIN william_forecasted_orders_temp b 
      ON 
        (
            b.date = a.date AND
            b.market = a.market AND
...
b.needs
FROM
william_availability_assignment a
FULL OUTER JOIN william_booked_forecasted_temp b 
  ON (
